...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ submitDataAction(prevState, formData) {
    try {
        ...
        if (success) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Also revalidate admin page, in case any part of it depends on sheet data or for general refresh
            return {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ saveSheetConfigAction(prevState, formData) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate admin to reflect any UI changes potentially related to config.
        return {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0e1b85fc._.js.map