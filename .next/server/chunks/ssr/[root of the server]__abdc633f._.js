...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ loginAction(prevState, formData) {
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkCredentials"])(username, password)) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate admin path to trigger UI update after login
            return {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ logoutAction() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate admin path to trigger UI update after logout
}
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ submitDataAction(prevState, formData) {
    try {
        ...
        if (success) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/'); // Revalidate the homepage cache to show the new data
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate admin page to update dashboard preview
            return {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ testSheetConnectionAction(prevState) {
    ...
    try {
        ...
        if (response.status === 200 && response.data.properties?.title) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin'); // Revalidate on successful test
            return {
                success: true,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__abdc633f._.js.map